...
var cardan=document.getElementById("cardano");
var avalanche=document.getElementById("avalanche");

var settings={
    "async" : true,
    "scrossDomain":true,
    "url": "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin%2Cethereum%2Ctether%2Ccardano%2Csolana&vs_currencies=usd",
    "method": "GET",
    "headers":{}
}
$.ajax(settings).done(function(response){
    ...
    cardan.innerHTML = response.cardano.usd;
    avalanche.innerHTML = response.avalanche.usd;
})
